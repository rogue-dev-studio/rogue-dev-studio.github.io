...
(function (global) {
    ...
    const PACKS = {
        id: {
            ...
            contactLead: 'Ceritakan kebutuhan proyek Anda. Saya balas ke email yang Anda cantumkan — alamat inbox tidak ditampilkan di halaman ini.',
            labelName: 'Nama',
            ...
            contactSponsorShort: '<a href="https://github.com/sponsors/rogue-dev-studio" target="_blank" rel="noopener noreferrer">Sponsor di GitHub</a> · <a href="https://www.patreon.com/c/roguedevstudio" target="_blank" rel="noopener noreferrer">Patreon</a>',
        ...
        en: {
            ...
            contactLead: 'Tell us what you need. I reply to the email you provide — the inbox address is not shown on this page.',
            labelName: 'Name',
            ...
            contactSponsorShort: '<a href="https://github.com/sponsors/rogue-dev-studio" target="_blank" rel="noopener noreferrer">Sponsor on GitHub</a> · <a href="https://www.patreon.com/c/roguedevstudio" target="_blank" rel="noopener noreferrer">Patreon</a>',
